          ...
          <tr>
            <td style="background-color: #dc3545; padding: 40px 30px; text-align: center;">
              <div style="width: 60px; height: 60px; background-color: #ffffff; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center;">
                <span style="color: #dc3545; font-size: 36px; line-height: 60px;">✕</span>
              </div>
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">Pago Rechazado</h1>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 20px; color: #333333; font-size: 16px; line-height: 1.6;">
                Lamentamos informarte que tu pago <strong>no pudo ser procesado</strong>.
              </p>
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0;">
                <tr>
                  <td>
                    <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.6;">
                      ...
                      • Límite de crédito excedido<br>
                      • Restricción del banco emisor
                    </p>
                  </td>
                </tr>
              </table>
              <p style="margin: 0 0 30px; color: #333333; font-size: 16px; line-height: 1.6;">
                Por favor, verifica tu método de pago e intenta nuevamente. Si el problema persiste, contacta a tu banco o a nuestro equipo de soporte.
              </p>
